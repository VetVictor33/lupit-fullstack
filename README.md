...
### Backend
  ...
  * `npm run build && npm start` para buildar e iniciar o backend na porta 3333 do localhost; ou
  * `npm run start:dev` para rodar em modo de desenvolvimento.

### Frotend

  * `npm install` p/ instalar as dependências;
  * `npm run build && npm start` para builda e rodar o projeto na porta 3000 do localhost; ou
